...
- **Linux:** MPRIS media controls, native Wayland/Tao support, AppImage, DEB and Arch packages. The Linux Native Image build uses the pinned Ubuntu 24.04 LTS compatibility baseline.
...
| Linux | **Stable** | Native Image AppImage, DEB and Arch package; build baseline is Ubuntu 24.04 LTS compatibility |
