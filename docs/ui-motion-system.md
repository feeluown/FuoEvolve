...
Hero transitions are reserved for a stable visual object that exists on both sides of a navigation change. They complement the existing page transition instead of replacing it.
