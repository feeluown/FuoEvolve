...
- **Linux**：支持 MPRIS 与原生 Wayland/Tao，提供 AppImage、DEB 与 Arch 包；Linux Native Image 固定使用 Ubuntu 24.04 LTS 兼容性 构建基线。
...
| Linux | **稳定版** | Native Image AppImage、DEB 与 Arch 包；构建基线为 Ubuntu 24.04 LTS 兼容性 |
